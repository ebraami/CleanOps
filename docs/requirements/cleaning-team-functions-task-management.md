# Cleaning Team Functions — Task Management
...
**Description:**  
The cleaning team should be able to update the status of an assigned task as the work progresses. The main task statuses are **Assigned**, **In Progress**, and **Completed**.

**Acceptance Condition:**  
When a team member changes the task status, the new status must be saved successfully and displayed to authorised users, including the operator and citizen where applicable.
...
**Description:**  
After completing the cleaning work, the cleaning team should upload photographic evidence showing the completed work. The evidence should be stored and linked to the related report.

**Acceptance Condition:**  
The cleaning team must be able to upload a completion image successfully, and the image must be associated with the correct report and available for the operator to review.
...
**Description:**  
The cleaning team should receive notifications when a new cleaning task is assigned and when important updates are made to an assigned task.

**Acceptance Condition:**  
When a new task is assigned to a cleaning team, the assigned team must receive a notification that allows them to identify and access the related task.
